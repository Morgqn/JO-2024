        ...
        <div class="modal-content">
            ...
            <center>
                <div class="modal-body step-1" data-step="1">
                    <p><input class="fInput" placeholder="First name..." id="surname" onblur="formatSurname(this)"></p>
                    <p><input class="fInput" placeholder="Last name..." id="name" onblur="formatName(this)"></p>
                    <p>
                        <select class="fSelect" id="selectGender">
                        <option>Male</option>
            ...
            <div class="modal-body step-2" data-step="2">
                <p><input class="fInput" type="mail" placeholder="Email" id="mail" onblur="isEmail(this)"></p>
                <p><input class="fInput" placeholder="Phone" id="phone" onblur="isPhone(this)"></p>
            </div>
            <div class="modal-body step-3" data-step="3">
                <p><input type="date" class="fInput" placeholder="dd" id="date" onblur="isDate(this)"></p>
                <p><input class="fInput" placeholder="Username..." id="username" onblur="isUsername(this)"></p>
                <p><input class="fInput" placeholder="Password..." id="pass" onblur="isPass(this)"></p>
            </div>
