...
">
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-2">
        <div class="portfolio-modal-dialog bg-white" style="padding: 5px;">
            ...
            <div class="col-lg-12 mx-auto" style="padding: 0;">
                <img class="img-fluid mb-5" src="img/portfolio/2.jpg" alt="" style="height: -webkit-fill-available;
                width: -webkit-fill-available; margin-bottom: 0px !important;
}
">
            </div>
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-3">
        <div class="portfolio-modal-dialog bg-white" style="padding: 5px;">
            ...
            <div class="col-lg-12 mx-auto" style="padding: 0;">
                <img class="img-fluid mb-5" src="img/portfolio/3.jpg" alt="" style="height: -webkit-fill-available;
                width: -webkit-fill-available; margin-bottom: 0px !important;
}
">
            </div>
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-4">
        <div class="portfolio-modal-dialog bg-white" style="padding: 5px;">
            ...
            <div class="col-lg-12 mx-auto" style="padding: 0;">
                <img class="img-fluid mb-5" src="img/portfolio/4.jpg" alt="" style="height: -webkit-fill-available;
                width: -webkit-fill-available; margin-bottom: 0px !important;
}
">
            </div>
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-5">
        <div class="portfolio-modal-dialog bg-white" style="padding: 5px;">
            ...
            <div class="col-lg-12 mx-auto" style="padding: 0;">
                <img class="img-fluid mb-5" src="img/portfolio/5.jpg" alt="" style="height: -webkit-fill-available;
                width: -webkit-fill-available; margin-bottom: 0px !important;
}
">
            </div>
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-6">
        <div class="portfolio-modal-dialog bg-white" style="padding: 5px;">
            ...
            <div class="col-lg-12 mx-auto" style="padding: 0;">
                <img class="img-fluid mb-5" src="img/portfolio/6.jpg" alt="" style="height: -webkit-fill-available;
                width: -webkit-fill-available; margin-bottom: 0px !important;
}
">
            </div>
